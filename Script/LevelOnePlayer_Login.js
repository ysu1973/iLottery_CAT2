function LevelOnePlayerLogin() {
  ...
  Aliases.browser.pageGeorgiaLottery.linkSignIn.formLogin.emailinputEmailAddress2.SetText("reg1_ys@georgialotto.com");
...
module.exports.levelOnePlayerLogin = LevelOnePlayerLogin();
